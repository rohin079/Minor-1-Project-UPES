    ...
    <div className={`bdy ${props.theme === 'dark' ? 'dark-mode' : ''}`}>
      <div className='row'>
        <div className='banner-ad col col-sm-6' style={{ color: `${props.theme === 'dark' ? '#f5f5f5' : '#333'}` }}>
          <h2 className='title'><div style={{ color: '#9C27B0', fontSize:"80px" }}>UNI</div>  - <span className='found'>Connect</span></h2>
        ...
        <div className='banner col col-sm-6'>
          <img src={"http://media.giphy.com/media/3oEdvaba4h0I536VYQ/giphy.gif"} alt='logo' className='logo' />
        </div>
      </div>
    </div>
  );
